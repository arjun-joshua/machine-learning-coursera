...
z2 = Theta1 * a1;    
a2 = [ones(1,m) ; sigmoid(z2)];%hidden layer (matrix over all training data) with bias
    
a3 = sigmoid(Theta2 * a2);%output unit (matrix containing output vectors for all training data)

Y = zeros(num_labels,m);
%Y = eye(num_labels)(y,:); Y = Y';%code for 'vector indexing' from Coursera forum
